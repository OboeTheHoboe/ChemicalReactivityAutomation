### Script para el modulo molecule_set escrito para hacer mas faciles y rapidos los calculos de los conjuntos de moleculas
### Autor:Jorge Garcia Ponce DOMINGO 09 DE JUNIO 2019
...
"""def main():
	...
	test=Molecule_Set("rr","/Users/jorge/Desktop/coordinates.xyz")
	...
	for i in range(3):
		if i == 0:
				print("X: " + str(test.center_of_mass[i]))
		if i == 1:
			print("Y: " + str(test.center_of_mass[i]))
		if i == 2:
			print("Z: " + str(test.center_of_mass[i]))
	print(test.standard_coordinates)
main()"""
